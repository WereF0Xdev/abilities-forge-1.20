...
public class Modelghost_block<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("classes", "modelghost_block"), "main");
	public final ModelPart cube;

	public Modelghost_block(ModelPart root) {
